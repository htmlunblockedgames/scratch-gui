...
/* generated l10n code */Scratch.translate.setup({"de":{"_Camera V1":"Kamera V1"},"fi":{"_Camera V1":"Kamera V1","_background color":"taustaväri","_camera direction":"kameran suunta","_camera x":"kameran x-sijainti","_camera y":"kameran y-sijainti","_camera zoom":"kameran lähennys","_change camera x by [val]":"lisää kameran x:n arvoon [val]","_change camera y by [val]":"lisää kameran y:n arvoon [val]","_change camera zoom by [val]":"lähennä kameraa arvolla [val]","_move camera [val] steps":"liikuta kameraa [val] askelta ","_move camera to [sprite]":"siirrä kamera hahmon [sprite] kohdalle","_no sprites exist":"ei hahmoja","_point camera towards [sprite]":"kohdista kamera hahmon [sprite] suuntaan","_set background color to [val]":"aseta taustaväriksi [val]","_set camera direction to [val]":"kohdista kamera suuntaan [val]","_set camera to x: [x] y: [y]":"siirrä kamera sijaintiin x: [x] y: [y]","_set camera x to [val]":"aseta kameran x:n arvoksi [val]","_set camera y to [val]":"aseta kameran y:n arvoksi [val]","_set camera zoom to [val] %":"aseta kameran lähennykseksi [val] %","_stage to world x: [x]":"esiintymislavan x:stä maailman x: [x]","_stage to world y: [y]":"esiintymislavan y:stä maailman y:. [y]","_turn camera [image] [val] degrees":"käännä kameraa [image] [val] astetta"},"hu":{"_Camera V1":"Kamera V1","_background color":"háttérszín","_camera direction":"kamera iránya","_camera x":"kamera x","_camera y":"kamera y","_camera zoom":"kamera nagyítása","_change camera x by [val]":"kamera x-je változzon [val]","_change camera y by [val]":"kamera y-ja változzon [val]","_change camera zoom by [val]":"kamera nagyítása változzon [val]%","_move camera [val] steps":"kamera menjen [val] lépést","_move camera to [sprite]":"kamera ugorjon [sprite] helyére","_no sprites exist":"nincsenek szereplők","_point camera towards [sprite]":"kamera mutatása [sprite] felé","_set background color to [val]":"háttérszín legyen [val]","_set camera direction to [val]":"kamera iránya legyen [val]","_set camera to x: [x] y: [y]":"kamera ugorjon ide: x: [x] y: [y]","_set camera x to [val]":"kamera x-je legyen [val]","_set camera y to [val]":"kamera y-ja legyen [val]","_set camera zoom to [val] %":"kamera nagyítása legyen [val]%","_stage to world x: [x]":"világ x színpadtól: [x]","_stage to world y: [y]":"világ y színpadtól: [y]","_turn camera [image] [val] degrees":"kamera forduljon [image] [val] fokot"},"it":{"_background color":"colore di sfondo","_camera direction":"direzione camera","_camera x":"x camera","_camera y":"y camera","_camera zoom":"zoom camera","_change camera x by [val]":"cambia camera x di [val]","_change camera y by [val]":"cambia camera y di [val]","_change camera zoom by [val]":"cambia zoom camera di [val]","_move camera [val] steps":"sposta camera di [val]passi","_move camera to [sprite]":"sposta la camera dove si trova [sprite]","_no sprites exist":"non ci sono sprite","_point camera towards [sprite]":"punta camera verso [sprite]","_set background color to [val]":"usa colore di sfondo [val]","_set camera direction to [val]":"porta direzione camera a [val]","_set camera to x: [x] y: [y]":"sposta la camera a x: [x] y: [y]","_set camera x to [val]":"porta camera x a [val]","_set camera y to [val]":"porta camera y a [val]","_set camera zoom to [val] %":"porta zoom camera a [val] %","_stage to world x: [x]":"converti x: [x] del mondo in posizione dello Stage","_stage to world y: [y]":"converti y: [y] del mondo in posizione dello Stage","_turn camera [image] [val] degrees":"gira camera [image] di [val] gradi"},"ja":{"_Camera V1":"カメラ V1","_background color":"背景色","_camera direction":"カメラの向き","_camera x":"カメラのx座標","_camera y":"カメラのy座標","_camera zoom":"カメラズーム","_change camera x by [val]":"カメラのx座標を[val]ずつ変える","_change camera y by [val]":"カメラのy座標を[val]ずつ変える","_change camera zoom by [val]":"カメラのズームを[val]で変更する","_move camera [val] steps":"カメラを[val]歩動かす","_move camera to [sprite]":"カメラを[sprite]に移動する","_no sprites exist":"スプライトは存在しない","_point camera towards [sprite]":"カメラを[sprite]へ向ける","_set background color to [val]":"背景色を[val]に設定する","_set camera direction to [val]":"カメラを[val]度に向ける","_set camera to x: [x] y: [y]":"カメラのx座標を[x]、y座標を[y]にする","_set camera x to [val]":"カメラのx座標を[val]にする","_set camera y to [val]":"カメラのy座標を[val]にする","_set camera zoom to [val] %":"カメラのズームを[val]%に設定する","_stage to world x: [x]":"ステージから見た世界のx座標[x]","_stage to world y: [y]":"ステージから見た世界のy座標[y]","_turn camera [image] [val] degrees":"カメラを[image][val]度回す"},"ko":{"_Camera V1":"카메라 V1","_background color":"배경색","_camera direction":"카메라 방향","_camera x":"카메라 x","_camera y":"카메라 y","_camera zoom":"카메라 줌","_change camera x by [val]":"카메라의 x좌표를 [val]만큼 바꾸기","_change camera y by [val]":"카메라의 y좌표를 [val]만큼 바꾸기","_change camera zoom by [val]":"카메라의 줌을 [val]만큼 바꾸기","_move camera [val] steps":"카메라를 [val] 만큼 움직이기","_move camera to [sprite]":"카메라를 [sprite](으)로 이동하기","_no sprites exist":"(스프라이트 없음)","_point camera towards [sprite]":"카메라를 [sprite]쪽으로 바라보기","_set background color to [val]":"배경색을 [val](으)로 정하기","_set camera direction to [val]":"카메라의 방향을 [val](으)로 정하기","_set camera to x: [x] y: [y]":"카메라를 x:[x] y:[y] (으)로 이동하기","_set camera x to [val]":"카메라의 x좌표를 [val](으)로 정하기","_set camera y to [val]":"카메라의 y좌표를 [val](으)로 정하기","_set camera zoom to [val] %":"카메라의 줌을 [val]%로 정하기","_turn camera [image] [val] degrees":"카메라를 [image] [val]도 돌기"},"nb":{"_background color":"Bakgrunnsfarge","_camera direction":"kamera retning","_camera x":"kamera x","_camera y":"kamera y","_camera zoom":"kamera zoom","_change camera x by [val]":"endre kamera x med [val]","_change camera y by [val]":"endre kamera y med [val]","_change camera zoom by [val]":"endre kamera zoom med [val]","_move camera [val] steps":"flytt kamera [val] trinn","_move camera to [sprite]":"flytt kamera til [sprite]","_no sprites exist":"ingen sprites eksisterer","_point camera towards [sprite]":"peker kameraet mot [sprite]","_set background color to [val]":"sett bakgrunnsfarge til [val]","_set camera direction to [val]":"sett kamera retning til [val]","_set camera to x: [x] y: [y]":"sett kamera til x: [x] y: [y]","_set camera x to [val]":"sett kamera x til [val]","_set camera y to [val]":"sett kamera y til [val]","_set camera zoom to [val] %":"sett kamera zoom til [val] %","_turn camera [image] [val] degrees":"snu kamera [image] [val] grader"},"nl":{"_background color":"achtergrondkleur","_camera direction":"camera-richting","_camera x":"camera-x","_camera y":"camera-y","_camera zoom":"camera-zoom","_change camera x by [val]":"verander camera-x met [val]","_change camera y by [val]":"verander camera-y [val]","_change camera zoom by [val]":"verander camera-zoom met [val]","_move camera [val] steps":"verplaats camera [val] stappen","_move camera to [sprite]":"verplaats camera naar [sprite]","_no sprites exist":"...","_point camera towards [sprite]":"richt camera naar [sprite]","_set background color to [val]":"maak achtergrondkleur [val]","_set camera direction to [val]":"richt camera naar [val] graden","_set camera to x: [x] y: [y]":"verplaats camera naar x: [x] y: [y]","_set camera x to [val]":"maak camera-x [val]","_set camera y to [val]":"maak camera-y [val]","_set camera zoom to [val] %":"maak camera-zoom [val] %","_turn camera [image] [val] degrees":"draai camera [image] [val] graden"},"pl":{"_background color":"kolor tła"},"ru":{"_Camera V1":"Камера V1","_background color":"цвет заднего фона","_camera direction":"направление камеры","_camera x":"x камеры","_camera y":"y камеры","_camera zoom":"приближение камеры","_change camera x by [val]":"изменить x камеры на [val]","_change camera y by [val]":"изменить y камеры на [val]","_change camera zoom by [val]":"изменить приближение камеры на [val]","_move camera [val] steps":"камерой идти [val] шагов","_move camera to [sprite]":"переместить камеру на [sprite]","_no sprites exist":"никаких спрайтов не существует","_point camera towards [sprite]":"навести камеру на [sprite]","_set background color to [val]":"задать цвет заднего фона на [val]","_set camera direction to [val]":"задать направление камеры на [val]","_set camera to x: [x] y: [y]":"задать позицию камеры на x: [x] y: [y]","_set camera x to [val]":"задать x камеры на [val]","_set camera y to [val]":"задать y камеры на [val]","_set camera zoom to [val] %":"задать приближение камены в [val]%","_stage to world x: [x]":"сцену на x мира: [x]","_stage to world y: [y]":"сцену на y мира: [y]","_turn camera [image] [val] degrees":"повернуть камеру [image] на [val] градусов"},"zh-cn":{"_Camera V1":"摄像机 V1","_background color":"背景颜色","_camera direction":"摄像机的方向","_camera x":"摄像机x坐标","_camera y":"摄像机y坐标","_camera zoom":"摄像机视野","_change camera x by [val]":"摄像机的x坐标增加[val]","_change camera y by [val]":"摄像机的y坐标增加[val]","_change camera zoom by [val]":"摄像机拉近[val]","_move camera [val] steps":"摄像机移动[val]步","_move camera to [sprite]":"移动摄像机到角色[sprite]","_no sprites exist":"没有角色","_point camera towards [sprite]":"摄像机面向[sprite]","_set background color to [val]":"将背景颜色设为[val]","_set camera direction to [val]":"将摄像机的方向设为[val]","_set camera to x: [x] y: [y]":"将摄像机的坐标设为x：[x] y：[y]","_set camera x to [val]":"将摄像机的x坐标设为[val]","_set camera y to [val]":"将摄像机的y坐标设为[val]","_set camera zoom to [val] %":"将摄像机视野设为[val]%","_stage to world x: [x]":"舞台到世界x：[x]","_stage to world y: [y]":"舞台到世界y：[y]","_turn camera [image] [val] degrees":"摄像机[image][val]度"}});/* end generated l10n code */((Scratch) => {
  "use strict";
